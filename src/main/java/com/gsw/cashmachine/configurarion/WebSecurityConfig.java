...
import com.gsw.cashmachine.authentication.security.AuthenticationTokenFilter;
import com.gsw.cashmachine.authentication.security.EntryPointUnauthorizedHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/cashmachine/**").permitAll()
